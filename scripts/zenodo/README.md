...
- `nnunet_liver_lits_ens5.json`: the 5-fold ensemble manifest. It has no ONNX of its own and lists the members (id + sha256), `aggregation: logit-mean` (as `nnUNetv2_predict`) and `tta: mirror`
